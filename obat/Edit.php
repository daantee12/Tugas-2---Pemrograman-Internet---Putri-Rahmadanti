<?php
$id = $_GET['kode_obat']; include 'model.php';
$model = new Model();
$data = $model->edit($id);
?>
<!doctype html>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <h1>Edit Data Obat</h1></a>

  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#">Data Obat <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
...
<div class="form-group">
    ...
    <input class="form-control" type="text" name="kode_obat" value="<?php echo $data->kode_obat ?>">
</div>
