...
<h1>Data Penjualan</h1></a>

  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item">
        <a class="nav-link" href="../index.php">Data Obat <span class="sr-only">(current)</span></a>
      </li>
...
<td>
<a name="edit" id="edit" href="edit.php?kode_penjualan=<?= $data->kode_penjualan ?>">Edit</a> /
<a name="hapus" id="hapus" href="proses.php?kode_penjualan=<?= $data->kode_penjualan ?>">Delete</a>
</td>
</tr>
<?php endforeach;
} else { ?>
